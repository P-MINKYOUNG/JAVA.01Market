...
public class Application {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println("=============================");
//		System.out.print("오늘의 장보기 : " + Randomproduct.get(0));
		System.out.println();
		System.out.println("=============================");
		...
		while (true) {
			...
			if (select == '1') {
//				pro.selectProduct(pro.loadProductList());
				break;
			} else if (select == '2') {
...
//				sangyong.selectProduct(pro.loadProductList());
		...
		pro.reciept(pro.selectProduct(pro.loadProductList()));

// 받아온 배열중에서 랜덤으로 배열인덱스, 상품 리스트 3개를 추출해서 > 마트를 고르고 A마트 / B 마트 / C 마트 >
